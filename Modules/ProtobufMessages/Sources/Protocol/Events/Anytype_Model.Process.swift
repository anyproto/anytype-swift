...
extension Anytype_Model.Process: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{2}\u{2}state\0\u{1}progress\0\u{1}spaceId\0\u{1}dropFiles\0\u{1}import\0\u{1}export\0\u{1}saveFile\0\u{1}migration\0\u{1}error\0\u{1}preloadFile\0")
