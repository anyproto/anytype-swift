...
extension Anytype_Event {
    ...
    public var objectCleanupSuggestion: Anytype_Event.Object.CleanupSuggestion {
      get {
        if case .objectCleanupSuggestion(let v)? = value {return v}
        return Anytype_Event.Object.CleanupSuggestion()
      }
      set {value = .objectCleanupSuggestion(newValue)}
    }
...
extension Anytype_Event.Message: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 146: try {
        var v: Anytype_Event.Object.CleanupSuggestion?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
          if case .objectCleanupSuggestion(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .objectCleanupSuggestion?: try {
