...
extension Anytype_Event {
    ...
    public var chatUpdatePinnedStatus: Anytype_Event.Chat.UpdatePinnedStatus {
      get {
        if case .chatUpdatePinnedStatus(let v)? = value {return v}
        return Anytype_Event.Chat.UpdatePinnedStatus()
      }
      set {value = .chatUpdatePinnedStatus(newValue)}
    }

    public var chatUpdateReactionReadStatus: Anytype_Event.Chat.UpdateReactionReadStatus {
      get {
        if case .chatUpdateReactionReadStatus(let v)? = value {return v}
        return Anytype_Event.Chat.UpdateReactionReadStatus()
      }
      set {value = .chatUpdateReactionReadStatus(newValue)}
    }

    public var objectAutoArchive: Anytype_Event.Object.AutoArchive {
      get {
        if case .objectAutoArchive(let v)? = value {return v}
        return Anytype_Event.Object.AutoArchive()
      }
      set {value = .objectAutoArchive(newValue)}
    }

    public var objectAutoRestore: Anytype_Event.Object.AutoRestore {
      get {
        if case .objectAutoRestore(let v)? = value {return v}
        return Anytype_Event.Object.AutoRestore()
      }
      set {value = .objectAutoRestore(newValue)}
    }

    public var debugProfileCreated: Anytype_Event.Debug.ProfileCreated {
      get {
        if case .debugProfileCreated(let v)? = value {return v}
        return Anytype_Event.Debug.ProfileCreated()
      }
      set {value = .debugProfileCreated(newValue)}
    }

    /// received whenever the total number of non-deleted messages in
    public var chatUpdateMessageCount: Anytype_Event.Chat.UpdateMessageCount {
      get {
        if case .chatUpdateMessageCount(let v)? = value {return v}
        return Anytype_Event.Chat.UpdateMessageCount()
      }
      set {value = .chatUpdateMessageCount(newValue)}
    }
    ...
    public var membershipV2Update: Anytype_Event.MembershipV2.Update {
      get {
        if case .membershipV2Update(let v)? = value {return v}
        return Anytype_Event.MembershipV2.Update()
      }
      set {value = .membershipV2Update(newValue)}
    }

    public var membershipV2ProductsUpdate: Anytype_Event.MembershipV2.ProductsUpdate {
      get {
        if case .membershipV2ProductsUpdate(let v)? = value {return v}
        return Anytype_Event.MembershipV2.ProductsUpdate()
      }
...
extension Anytype_Event.Message: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 138: try {
        var v: Anytype_Event.MembershipV2.Update?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
          if case .membershipV2Update(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.value = .membershipV2Update(v)
        }
      }()
      case 139: try {
        var v: Anytype_Event.MembershipV2.ProductsUpdate?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
          if case .membershipV2ProductsUpdate(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.value = .membershipV2ProductsUpdate(v)
        }
      }()
      case 140: try {
        var v: Anytype_Event.Chat.UpdatePinnedStatus?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
          if case .chatUpdatePinnedStatus(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.value = .chatUpdatePinnedStatus(v)
        }
      }()
      case 141: try {
        var v: Anytype_Event.Chat.UpdateReactionReadStatus?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
          if case .chatUpdateReactionReadStatus(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.value = .chatUpdateReactionReadStatus(v)
        }
      }()
      case 142: try {
        var v: Anytype_Event.Object.AutoArchive?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
          if case .objectAutoArchive(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.value = .objectAutoArchive(v)
        }
      }()
      case 143: try {
        var v: Anytype_Event.Object.AutoRestore?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
          if case .objectAutoRestore(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.value = .objectAutoRestore(v)
        }
      }()
      case 144: try {
        var v: Anytype_Event.Chat.UpdateMessageCount?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
          if case .chatUpdateMessageCount(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.value = .chatUpdateMessageCount(v)
        }
      }()
      case 145: try {
        var v: Anytype_Event.Debug.ProfileCreated?
        var hadOneofValue = false
        if let current = self.value {
          hadOneofValue = true
          if case .debugProfileCreated(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.value = .debugProfileCreated(v)
        }
      }()
      case 201: try {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .membershipV2Update?: try {
      guard case .membershipV2Update(let v)? = self.value else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 138)
    }()
    case .membershipV2ProductsUpdate?: try {
      guard case .membershipV2ProductsUpdate(let v)? = self.value else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 139)
    }()
    case .chatUpdatePinnedStatus?: try {
      guard case .chatUpdatePinnedStatus(let v)? = self.value else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 140)
    }()
    case .chatUpdateReactionReadStatus?: try {
      guard case .chatUpdateReactionReadStatus(let v)? = self.value else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 141)
    }()
    case .objectAutoArchive?: try {
      guard case .objectAutoArchive(let v)? = self.value else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 142)
    }()
    case .objectAutoRestore?: try {
      guard case .objectAutoRestore(let v)? = self.value else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 143)
    }()
    case .chatUpdateMessageCount?: try {
      guard case .chatUpdateMessageCount(let v)? = self.value else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 144)
    }()
    case .debugProfileCreated?: try {
      guard case .debugProfileCreated(let v)? = self.value else { preconditionFailure() }
