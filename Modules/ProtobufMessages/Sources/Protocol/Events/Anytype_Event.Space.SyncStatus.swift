...
extension Anytype_Event.Space {
    public struct SyncStatus: Sendable {
      ...
      public struct Update: Sendable {
        ...
        public var uploadingFilesCounter: Int64 = 0
...
extension Anytype_Event.Space.SyncStatus.Update: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}status\0\u{1}network\0\u{1}error\0\u{1}syncingObjectsCounter\0\u{1}notSyncedFilesCounter\0\u{1}uploadingFilesCounter\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularInt64Field(value: &self.uploadingFilesCounter) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.uploadingFilesCounter != 0 {
      try visitor.visitSingularInt64Field(value: self.uploadingFilesCounter, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Anytype_Event.Space.SyncStatus.Update, rhs: Anytype_Event.Space.SyncStatus.Update) -> Bool {
    ...
    if lhs.uploadingFilesCounter != rhs.uploadingFilesCounter {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
