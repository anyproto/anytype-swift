...
public struct Anytype_Model_ObjectStoreChecksums: @unchecked Sendable {
  ...
  public var reindexFulltextChatMessages: Int32 {
    get {return _storage._reindexFulltextChatMessages}
  ...
  public var reindexDiscussions: Int32 {
    get {return _storage._reindexDiscussions}
    set {_uniqueStorage()._reindexDiscussions = newValue}
  }
...
extension Anytype_Model_ObjectInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}objectTypeUrls\0\u{1}details\0\u{1}relations\0\u{1}snippet\0\u{1}hasInboundLinks\0")
...
extension Anytype_Model_ObjectLinks: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}inboundIDs\0\u{1}outboundIDs\0")
...
extension Anytype_Model_ObjectLinksInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}inbound\0\u{1}outbound\0")
...
extension Anytype_Model_ObjectInfoWithLinks: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}info\0\u{1}links\0")
...
extension Anytype_Model_ObjectInfoWithOutboundLinks: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}info\0\u{1}outboundLinks\0")
...
extension Anytype_Model_ObjectStoreChecksums: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}bundledObjectTypes\0\u{1}bundledRelations\0\u{1}bundledLayouts\0\u{1}objectsForceReindexCounter\0\u{1}filesForceReindexCounter\0\u{1}idxRebuildCounter\0\u{1}fulltextRebuild\0\u{1}bundledTemplates\0\u{1}bundledObjects\0\u{1}filestoreKeysForceReindexCounter\0\u{1}fulltextErase\0\u{1}areOldFilesRemoved\0\u{1}areDeletedObjectsReindexed\0\u{1}linksErase\0\u{1}marketplaceForceReindexCounter\0\u{1}reindexDeletedObjects\0\u{1}reindexParticipants\0\u{1}reindexChats\0\u{1}reindexFulltextChatMessages\0\u{1}invalidateObjectsIndex\0\u{1}reindexDiscussions\0")
  ...
  fileprivate class _StorageClass {
    ...
    var _reindexDiscussions: Int32 = 0
    ...
    init(copying source: _StorageClass) {
      ...
      _reindexDiscussions = source._reindexDiscussions
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 21: try { try decoder.decodeSingularInt32Field(value: &_storage._reindexDiscussions) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._reindexDiscussions != 0 {
        try visitor.visitSingularInt32Field(value: _storage._reindexDiscussions, fieldNumber: 21)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Anytype_Model_ObjectStoreChecksums, rhs: Anytype_Model_ObjectStoreChecksums) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._reindexDiscussions != rhs_storage._reindexDiscussions {return false}
        return true
      }
