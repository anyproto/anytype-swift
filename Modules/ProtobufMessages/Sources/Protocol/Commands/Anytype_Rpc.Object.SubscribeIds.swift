...
extension Anytype_Rpc.Object {
    public struct SubscribeIds: Sendable {
...
extension Anytype_Rpc.Object.SubscribeIds.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}subId\0\u{1}ids\0\u{1}keys\0\u{2}\u{9}noDepSubscription\0\u{1}spaceId\0")
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.spaceID.isEmpty {
      try visitor.visitSingularStringField(value: self.spaceID, fieldNumber: 13)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Anytype_Rpc.Object.SubscribeIds.Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}error\0\u{1}records\0\u{1}dependencies\0\u{1}subId\0")
