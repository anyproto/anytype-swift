...
extension Anytype_Rpc.Chat.ReadMessages.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}chatObjectId\0\u{1}afterOrderId\0\u{1}beforeOrderId\0\u{1}lastStateId\0")
...
extension Anytype_Rpc.Chat.ReadMessages.Response.Error.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NULL\0\u{1}UNKNOWN_ERROR\0\u{1}BAD_INPUT\0\u{2}b\u{1}MESSAGES_NOT_FOUND\0")
}
