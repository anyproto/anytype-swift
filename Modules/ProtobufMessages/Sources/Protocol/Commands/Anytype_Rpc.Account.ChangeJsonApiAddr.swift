...
extension Anytype_Rpc.Account {
    public struct ChangeJsonApiAddr: Sendable {
      ...
      public struct Response: Sendable {
        ...
        public struct Error: Sendable {
          ...
          public enum Code: SwiftProtobuf.Enum, Swift.CaseIterable {
            ...
            public static let allCases: [Anytype_Rpc.Account.ChangeJsonApiAddr.Response.Error.Code] = [
              .null,
              .unknownError,
              .badInput,
              .accountIsNotRunning,
...
extension Anytype_Rpc.Account.ChangeJsonApiAddr.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}listenAddr\0")
...
extension Anytype_Rpc.Account.ChangeJsonApiAddr.Response.Error.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NULL\0\u{1}UNKNOWN_ERROR\0\u{1}BAD_INPUT\0\u{2}\u{2}ACCOUNT_IS_NOT_RUNNING\0")
}
