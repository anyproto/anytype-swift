...
extension Anytype_Rpc.App {
    public struct SetDeviceState: Sendable {
...
extension Anytype_Rpc.App.SetDeviceState.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}deviceState\0")
...
extension Anytype_Rpc.App.SetDeviceState.Request.DeviceState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0BACKGROUND\0\u{1}FOREGROUND\0")
}
