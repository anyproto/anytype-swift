...
extension Anytype_Rpc.BlockWidget {
    public struct SetTargetId: Sendable {
...
extension Anytype_Rpc.BlockWidget.SetTargetId.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}contextId\0\u{1}blockId\0\u{1}targetId\0")
