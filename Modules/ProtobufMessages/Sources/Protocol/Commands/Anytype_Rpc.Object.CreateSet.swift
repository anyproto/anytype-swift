...
extension Anytype_Rpc.Object {
    public struct CreateSet: Sendable {
...
extension Anytype_Rpc.Object.CreateSet.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}source\0\u{1}details\0\u{1}templateId\0\u{1}internalFlags\0\u{1}spaceId\0\u{1}withChat\0")
...
extension Anytype_Rpc.Object.CreateSet.Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}error\0\u{2}\u{2}objectId\0\u{1}event\0\u{1}details\0")
...
extension Anytype_Rpc.Object.CreateSet.Response.Error.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NULL\0\u{1}UNKNOWN_ERROR\0\u{1}BAD_INPUT\0\u{1}UNKNOWN_OBJECT_TYPE_URL\0")
}
