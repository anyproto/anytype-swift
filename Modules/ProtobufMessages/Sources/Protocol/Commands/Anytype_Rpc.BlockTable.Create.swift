...
extension Anytype_Rpc.BlockTable {
...
extension Anytype_Rpc.BlockTable.Create.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4:
          try {
              try decoder.decodeSingularUInt32Field(value: &self.rows)
          }()
      case 5:
          try {
              try decoder.decodeSingularUInt32Field(value: &self.columns)
          }()
      case 6:
          try {
              try decoder.decodeSingularBoolField(value: &self.withHeaderRow)
          }()
      default:
          break
      }
  ...
  public static func ==(lhs: Anytype_Rpc.BlockTable.Create.Request, rhs: Anytype_Rpc.BlockTable.Create.Request) -> Bool {
    ...
    if lhs.withHeaderRow != rhs.withHeaderRow {
        return false
    }
    if lhs.unknownFields != rhs.unknownFields {
        return false
