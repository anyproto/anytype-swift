...
extension Anytype_Rpc.Membership {
    public struct GetVerificationEmail: Sendable {
...
extension Anytype_Rpc.Membership.GetVerificationEmail.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}email\0\u{1}subscribeToNewsletter\0\u{1}insiderTipsAndTutorials\0\u{1}isOnboardingList\0")
