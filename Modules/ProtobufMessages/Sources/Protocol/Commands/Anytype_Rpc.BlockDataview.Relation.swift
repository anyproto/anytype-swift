    ...
    public struct Relation: Sendable {
      ...
      public struct Set: Sendable {
        ...
        public struct Response: Sendable {
          ...
          public var error: Anytype_Rpc.BlockDataview.Relation.Set.Response.Error {
            get {return _error ?? Anytype_Rpc.BlockDataview.Relation.Set.Response.Error()}
            set {_error = newValue}
          }
          ...
          public struct Error: Sendable {
            ...
            public var code: Anytype_Rpc.BlockDataview.Relation.Set.Response.Error.Code = .null
            ...
            public enum Code: SwiftProtobuf.Enum, Swift.CaseIterable {
              ...
              public static let allCases: [Anytype_Rpc.BlockDataview.Relation.Set.Response.Error.Code] = [
                .null,
                .unknownError,
                .badInput,
              ]
          ...
          fileprivate var _error: Anytype_Rpc.BlockDataview.Relation.Set.Response.Error? = nil
...
extension Anytype_Rpc.BlockDataview.Relation.Set: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Anytype_Rpc.BlockDataview.Relation.protoMessageName + ".Set"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Anytype_Rpc.BlockDataview.Relation.Set, rhs: Anytype_Rpc.BlockDataview.Relation.Set) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Anytype_Rpc.BlockDataview.Relation.Set.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Anytype_Rpc.BlockDataview.Relation.Set.protoMessageName + ".Request"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}contextId\0\u{1}blockId\0\u{1}relationKeys\0")
  ...
  public static func ==(lhs: Anytype_Rpc.BlockDataview.Relation.Set.Request, rhs: Anytype_Rpc.BlockDataview.Relation.Set.Request) -> Bool {
...
extension Anytype_Rpc.BlockDataview.Relation.Set.Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Anytype_Rpc.BlockDataview.Relation.Set.protoMessageName + ".Response"
  ...
  public static func ==(lhs: Anytype_Rpc.BlockDataview.Relation.Set.Response, rhs: Anytype_Rpc.BlockDataview.Relation.Set.Response) -> Bool {
...
extension Anytype_Rpc.BlockDataview.Relation.Set.Response.Error: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Anytype_Rpc.BlockDataview.Relation.Set.Response.protoMessageName + ".Error"
  ...
  public static func ==(lhs: Anytype_Rpc.BlockDataview.Relation.Set.Response.Error, rhs: Anytype_Rpc.BlockDataview.Relation.Set.Response.Error) -> Bool {
...
extension Anytype_Rpc.BlockDataview.Relation.Set.Response.Error.Code: SwiftProtobuf._ProtoNameProviding {
...
extension Anytype_Rpc.BlockDataview.Relation.Delete.Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}error\0\u{2}\u{2}event\0")
