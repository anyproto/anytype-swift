...
extension Anytype_Rpc.Space {
    public struct InviteGetCurrent: Sendable {
...
extension Anytype_Rpc.Space.InviteGetCurrent.Response.Error.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NULL\0\u{1}UNKNOWN_ERROR\0\u{1}BAD_INPUT\0\u{2}c\u{1}NO_ACTIVE_INVITE\0")
}
