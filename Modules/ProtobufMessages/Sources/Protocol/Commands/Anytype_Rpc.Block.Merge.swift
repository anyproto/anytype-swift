...
extension Anytype_Rpc.Block.Merge.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2:
          try {
              try decoder.decodeSingularStringField(value: &self.firstBlockID)
          }()
      case 3:
          try {
              try decoder.decodeSingularStringField(value: &self.secondBlockID)
          }()
      default:
          break
      }
  ...
  public static func ==(lhs: Anytype_Rpc.Block.Merge.Request, rhs: Anytype_Rpc.Block.Merge.Request) -> Bool {
    ...
    if lhs.firstBlockID != rhs.firstBlockID {
        return false
    }
    if lhs.secondBlockID != rhs.secondBlockID {
        return false
    }
    if lhs.unknownFields != rhs.unknownFields {
        return false
