...
extension Anytype_Rpc.Account.Stop.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}removeData\0")
...
extension Anytype_Rpc.Account.Stop.Response.Error.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NULL\0\u{1}UNKNOWN_ERROR\0\u{1}BAD_INPUT\0\u{2}c\u{1}ACCOUNT_IS_NOT_RUNNING\0\u{1}FAILED_TO_STOP_NODE\0\u{1}FAILED_TO_REMOVE_ACCOUNT_DATA\0")
}
