...
extension Anytype_Rpc.ObjectType {
    public struct ListConflictingRelations: Sendable {
      ...
      public struct Response: Sendable {
        ...
        public struct Error: Sendable {
          ...
          public enum Code: SwiftProtobuf.Enum, Swift.CaseIterable {
            ...
            public static let allCases: [Anytype_Rpc.ObjectType.ListConflictingRelations.Response.Error.Code] = [
              .null,
              .unknownError,
              .badInput,
              .readonlyObjectType,
...
extension Anytype_Rpc.ObjectType.ListConflictingRelations.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}spaceId\0\u{1}typeObjectId\0")
...
extension Anytype_Rpc.ObjectType.ListConflictingRelations.Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}error\0\u{1}relationIds\0")
