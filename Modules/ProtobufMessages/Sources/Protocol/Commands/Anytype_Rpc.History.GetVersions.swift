...
extension Anytype_Rpc.History.GetVersions.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "limit"),
    4: .same(proto: "notIncludeVersion"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2:
          try {
              try decoder.decodeSingularStringField(value: &self.lastVersionID)
          }()
      case 3:
          try {
      ...
      case 4:
          try {
              try decoder.decodeSingularBoolField(value: &self.notIncludeVersion)
          }()
      default:
          break
      }
  ...
  public static func ==(lhs: Anytype_Rpc.History.GetVersions.Request, rhs: Anytype_Rpc.History.GetVersions.Request) -> Bool {
    ...
    if lhs.lastVersionID != rhs.lastVersionID {
        return false
    }
    if lhs.limit != rhs.limit {
        return false
    }
    if lhs.notIncludeVersion != rhs.notIncludeVersion {
        return false
    }
    if lhs.unknownFields != rhs.unknownFields {
        return false
...
extension Anytype_Rpc.History.GetVersions.Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2:
          try {
              try decoder.decodeRepeatedMessageField(value: &self.versions)
          }()
      default:
          break
      }
