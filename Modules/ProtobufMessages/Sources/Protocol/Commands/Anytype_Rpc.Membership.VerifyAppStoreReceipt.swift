...
extension Anytype_Rpc.Membership {
    public struct VerifyAppStoreReceipt: Sendable {
...
extension Anytype_Rpc.Membership.VerifyAppStoreReceipt.Response.Error.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NULL\0\u{1}UNKNOWN_ERROR\0\u{1}BAD_INPUT\0\u{1}NOT_LOGGED_IN\0\u{1}PAYMENT_NODE_ERROR\0\u{1}CACHE_ERROR\0\u{1}INVALID_RECEIPT\0\u{1}PURCHASE_REGISTRATION_ERROR\0\u{1}SUBSCRIPTION_RENEW_ERROR\0")
}
