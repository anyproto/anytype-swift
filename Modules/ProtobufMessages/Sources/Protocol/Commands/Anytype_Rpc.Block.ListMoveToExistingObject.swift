...
extension Anytype_Rpc.Block {
    public struct ListMoveToExistingObject: Sendable {
...
extension Anytype_Rpc.Block.ListMoveToExistingObject.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}contextId\0\u{1}blockIds\0\u{1}targetContextId\0\u{1}dropTargetId\0\u{1}position\0")
