...
extension Anytype_Rpc.BlockText {
    public struct SetIcon: Sendable {
...
extension Anytype_Rpc.BlockText.SetIcon.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}contextId\0\u{1}blockId\0\u{1}iconImage\0\u{2}\u{2}iconEmoji\0")
