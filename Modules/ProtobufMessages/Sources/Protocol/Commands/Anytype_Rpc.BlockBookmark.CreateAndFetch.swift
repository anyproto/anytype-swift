...
extension Anytype_Rpc.BlockBookmark {
    public struct CreateAndFetch: Sendable {
...
extension Anytype_Rpc.BlockBookmark.CreateAndFetch.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}contextId\0\u{1}targetId\0\u{1}position\0\u{1}url\0\u{1}templateId\0")
