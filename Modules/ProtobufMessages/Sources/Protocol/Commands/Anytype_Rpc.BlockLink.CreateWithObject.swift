...
extension Anytype_Rpc.BlockLink {
    public struct CreateWithObject: Sendable {
...
extension Anytype_Rpc.BlockLink.CreateWithObject.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}contextId\0\u{1}targetId\0\u{1}details\0\u{1}position\0\u{1}templateId\0\u{1}fields\0\u{1}internalFlags\0\u{1}spaceId\0\u{1}objectTypeUniqueKey\0\u{1}block\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularMessageField(value: &self._block) }()
      default: break
      }
    }
  }
...
extension Anytype_Rpc.BlockLink.CreateWithObject.Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}error\0\u{1}blockId\0\u{1}targetId\0\u{1}event\0\u{1}details\0")
