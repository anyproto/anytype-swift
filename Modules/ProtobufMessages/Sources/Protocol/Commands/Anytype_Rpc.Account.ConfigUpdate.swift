...
extension Anytype_Rpc.Account {
    public struct ConfigUpdate: Sendable {
      ...
      public enum Timezones: SwiftProtobuf.Enum, Swift.CaseIterable {
...
extension Anytype_Rpc.Account.ConfigUpdate.Timezones: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0GMT\0\u{1}ECT\0\u{1}EET\0\u{1}EAT\0\u{1}MET\0\u{1}NET\0\u{1}PLT\0\u{1}IST\0\u{1}BST\0\u{1}VST\0\u{1}CTT\0\u{1}JST\0\u{1}ACT\0\u{1}AET\0\u{1}SST\0\u{1}NST\0\u{1}MIT\0\u{1}HST\0\u{1}AST\0\u{1}PST\0\u{1}MST\0\u{1}CST\0\u{1}IET\0\u{1}PRT\0\u{1}CNT\0\u{1}BET\0\u{1}BRT\0\u{1}CAT\0")
}
...
extension Anytype_Rpc.Account.ConfigUpdate.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\u{2}IPFSStorageAddr\0")
...
extension Anytype_Rpc.Account.ConfigUpdate.Response.Error.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NULL\0\u{1}UNKNOWN_ERROR\0\u{1}BAD_INPUT\0\u{2}c\u{1}ACCOUNT_IS_NOT_RUNNING\0\u{1}FAILED_TO_WRITE_CONFIG\0")
}
