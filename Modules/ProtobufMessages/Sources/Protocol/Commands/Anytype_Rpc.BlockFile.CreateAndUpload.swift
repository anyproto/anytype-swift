...
extension Anytype_Rpc.BlockFile {
    public struct CreateAndUpload: Sendable {
...
extension Anytype_Rpc.BlockFile.CreateAndUpload.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}contextId\0\u{1}targetId\0\u{1}position\0\u{1}url\0\u{1}localPath\0\u{1}fileType\0\u{1}imageKind\0")
