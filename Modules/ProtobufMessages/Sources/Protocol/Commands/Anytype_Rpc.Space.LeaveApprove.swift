...
extension Anytype_Rpc.Space {
    public struct LeaveApprove: Sendable {
...
extension Anytype_Rpc.Space.LeaveApprove.Response.Error.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0NULL\0\u{1}UNKNOWN_ERROR\0\u{1}BAD_INPUT\0\u{2}c\u{1}NO_SUCH_SPACE\0\u{1}SPACE_IS_DELETED\0\u{1}REQUEST_FAILED\0\u{1}LIMIT_REACHED\0\u{1}NO_APPROVE_REQUESTS\0\u{1}NOT_SHAREABLE\0")
}
