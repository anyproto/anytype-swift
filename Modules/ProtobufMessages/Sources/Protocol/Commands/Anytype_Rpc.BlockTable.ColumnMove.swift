...
extension Anytype_Rpc.BlockTable {
    public struct ColumnMove: Sendable {
...
extension Anytype_Rpc.BlockTable.ColumnMove.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}contextId\0\u{1}targetId\0\u{1}dropTargetId\0\u{1}position\0")
