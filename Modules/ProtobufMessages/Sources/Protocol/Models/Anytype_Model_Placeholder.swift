...
public struct Anytype_Model_Placeholder: Sendable {
  ...
  public var values: [Anytype_Model_Placeholder.Value] = []
...
extension Anytype_Model_Placeholder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Placeholder"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}relationKey\0\u{1}values\0")
  ...
  public static func ==(lhs: Anytype_Model_Placeholder, rhs: Anytype_Model_Placeholder) -> Bool {
