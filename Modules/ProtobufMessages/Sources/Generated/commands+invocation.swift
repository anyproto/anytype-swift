...
extension Anytype_Rpc.ObjectType.Relation.List.Response: ResultWithError {}
extension Anytype_Rpc.ObjectType.Relation.List.Response.Error: ResponseError {
    public var isNull: Bool { code == .null }
}
...
extension Anytype_Rpc.Template.CreateFromObjectType.Response: ResultWithError {}
extension Anytype_Rpc.Template.CreateFromObjectType.Response.Error: ResponseError {
    public var isNull: Bool { code == .null }
}
...
extension Anytype_Rpc.UserData.Dump.Response: ResultWithError {}
extension Anytype_Rpc.UserData.Dump.Response.Error: ResponseError {
    public var isNull: Bool { code == .null }
}
