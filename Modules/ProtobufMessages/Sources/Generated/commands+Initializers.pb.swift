...
extension Anytype_Rpc.Account.ConfigUpdate.Response.Error {
    public init(code: Anytype_Rpc.Account.ConfigUpdate.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
...
extension Anytype_Rpc.Block.ListSetVerticalAlign.Request {
    public init(contextID: String = String(), blockIds: [String] = [], verticalAlign: Anytype_Model_Block.VerticalAlign = .top) {
        self.contextID = contextID
        self.blockIds = blockIds
...
extension Anytype_Rpc.Block.ListSetVerticalAlign.Response.Error {
    public init(code: Anytype_Rpc.Block.ListSetVerticalAlign.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.Block.Paste.Request {
    public init(contextID: String = String(), focusedBlockID: String = String(), selectedTextRange: Anytype_Model_Range, selectedBlockIds: [String] = [], isPartOfBlock: Bool = false, textSlot: String = String(), htmlSlot: String = String(), anySlot: [Anytype_Model_Block] = [], fileSlot: [Anytype_Rpc.Block.Paste.Request.File] = []) {
        self.contextID = contextID
...
extension Anytype_Rpc.Block.Split.Request {
    public init(contextID: String = String(), blockID: String = String(), range: Anytype_Model_Range, style: Anytype_Model_Block.Content.Text.Style = .paragraph, mode: Anytype_Rpc.Block.Split.Request.Mode = .bottom) {
        self.contextID = contextID
        self.blockID = blockID
        self.range = range
        self.style = style
...
extension Anytype_Rpc.BlockDataview.Relation.Add.Response {
    public init(error: Anytype_Rpc.BlockDataview.Relation.Add.Response.Error, event: Anytype_ResponseEvent) {
        self.error = error
        self.event = event
    }
}
...
extension Anytype_Rpc.BlockFile.CreateAndUpload.Request {
    public init(contextID: String = String(), targetID: String = String(), position: Anytype_Model_Block.Position = .none, url: String = String(), localPath: String = String(), fileType: Anytype_Model_Block.Content.File.TypeEnum = .none) {
        self.contextID = contextID
        self.targetID = targetID
        self.position = position
        self.url = url
...
extension Anytype_Rpc.BlockLink.CreateWithObject.Request {
    public init(contextID: String = String(), details: SwiftProtobuf.Google_Protobuf_Struct, templateID: String = String(), internalFlags: [Anytype_Model_InternalFlag] = [], targetID: String = String(), position: Anytype_Model_Block.Position = .none, fields: SwiftProtobuf.Google_Protobuf_Struct) {
        self.contextID = contextID
        self.details = details
...
extension Anytype_Rpc.BlockLink.ListSetAppearance.Request {
    public init(contextID: String = String(), blockIds: [String] = [], iconSize: Anytype_Model_Block.Content.Link.IconSize = .sizeNone, cardStyle: Anytype_Model_Block.Content.Link.CardStyle = .text, description_p: Anytype_Model_Block.Content.Link.Description = .none, relations: [String] = []) {
        self.contextID = contextID
        self.blockIds = blockIds
...
extension Anytype_Rpc.BlockTable.ColumnCreate.Request {
    public init(contextID: String = String(), targetID: String = String(), position: Anytype_Model_Block.Position = .none) {
        self.contextID = contextID
        self.targetID = targetID
        self.position = position
    }
...
extension Anytype_Rpc.BlockTable.ColumnCreate.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.ColumnCreate.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.ColumnDelete.Request {
    public init(contextID: String = String(), targetID: String = String()) {
        self.contextID = contextID
        self.targetID = targetID
    }
}
...
extension Anytype_Rpc.BlockTable.ColumnDelete.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.ColumnDelete.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.ColumnDuplicate.Request {
    public init(contextID: String = String(), targetID: String = String(), blockID: String = String(), position: Anytype_Model_Block.Position = .none) {
        self.contextID = contextID
        self.targetID = targetID
        self.blockID = blockID
        self.position = position
...
extension Anytype_Rpc.BlockTable.ColumnDuplicate.Response {
    public init(error: Anytype_Rpc.BlockTable.ColumnDuplicate.Response.Error, blockID: String = String(), event: Anytype_ResponseEvent) {
        self.error = error
        self.blockID = blockID
        self.event = event
    }
...
extension Anytype_Rpc.BlockTable.ColumnDuplicate.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.ColumnDuplicate.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.ColumnListFill.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.ColumnListFill.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.ColumnMove.Request {
    public init(contextID: String = String(), targetID: String = String(), dropTargetID: String = String(), position: Anytype_Model_Block.Position = .none) {
        self.contextID = contextID
        self.targetID = targetID
        self.dropTargetID = dropTargetID
        self.position = position
...
extension Anytype_Rpc.BlockTable.ColumnMove.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.ColumnMove.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.Create.Request {
    public init(contextID: String = String(), targetID: String = String(), position: Anytype_Model_Block.Position = .none, rows: UInt32 = 0, columns: UInt32 = 0, withHeaderRow: Bool = false) {
        self.contextID = contextID
        self.targetID = targetID
        self.position = position
        self.rows = rows
...
extension Anytype_Rpc.BlockTable.Create.Response {
    public init(error: Anytype_Rpc.BlockTable.Create.Response.Error, blockID: String = String(), event: Anytype_ResponseEvent) {
        self.error = error
        self.blockID = blockID
        self.event = event
    }
...
extension Anytype_Rpc.BlockTable.Create.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.Create.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.Expand.Request {
    public init(contextID: String = String(), targetID: String = String(), columns: UInt32 = 0, rows: UInt32 = 0) {
        self.contextID = contextID
        self.targetID = targetID
        self.columns = columns
        self.rows = rows
...
extension Anytype_Rpc.BlockTable.Expand.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.Expand.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.RowCreate.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.RowCreate.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.RowDelete.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.RowDelete.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.RowDuplicate.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.RowDuplicate.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.RowListClean.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.RowListClean.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.RowListFill.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.RowListFill.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.RowSetHeader.Request {
    public init(contextID: String = String(), targetID: String = String(), isHeader: Bool = false) {
        self.contextID = contextID
        self.targetID = targetID
...
extension Anytype_Rpc.BlockTable.RowSetHeader.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.RowSetHeader.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockTable.Sort.Request {
    public init(contextID: String = String(), columnID: String = String(), type: Anytype_Model_Block.Content.Dataview.Sort.TypeEnum = .asc) {
        self.contextID = contextID
...
extension Anytype_Rpc.BlockTable.Sort.Response.Error {
    public init(code: Anytype_Rpc.BlockTable.Sort.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockText.ListClearContent.Response.Error {
    public init(code: Anytype_Rpc.BlockText.ListClearContent.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.BlockText.ListClearStyle.Response.Error {
    public init(code: Anytype_Rpc.BlockText.ListClearStyle.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.Debug.Sync.Response {
    public init(error: Anytype_Rpc.Debug.Sync.Response.Error, threads: [Anytype_Rpc.Debug.threadInfo] = [], deviceID: String = String(), totalThreads: Int32 = 0, threadsWithoutReplInOwnLog: Int32 = 0, threadsWithoutHeadDownloaded: Int32 = 0, totalRecords: Int32 = 0, totalSize: Int32 = 0) {
        self.error = error
...
extension Anytype_Rpc.Debug.logInfo {
    public init(id: String = String(), head: String = String(), headDownloaded: Bool = false, totalRecords: Int32 = 0, totalSize: Int32 = 0, firstRecordTs: Int32 = 0, firstRecordVer: Int32 = 0, lastRecordTs: Int32 = 0, lastRecordVer: Int32 = 0, lastPullSecAgo: Int32 = 0, upStatus: String = String(), downStatus: String = String(), error: String = String()) {
        self.id = id
        self.head = head
...
extension Anytype_Rpc.Debug.threadInfo {
    public init(id: String = String(), logsWithDownloadedHead: Int32 = 0, logsWithWholeTreeDownloaded: Int32 = 0, logs: [Anytype_Rpc.Debug.logInfo] = [], ownLogHasCafeReplicator: Bool = false, cafeLastPullSecAgo: Int32 = 0, cafeUpStatus: String = String(), cafeDownStatus: String = String(), totalRecords: Int32 = 0, totalSize: Int32 = 0, error: String = String()) {
        self.id = id
...
extension Anytype_Rpc.File.Upload.Request {
    public init(url: String = String(), localPath: String = String(), type: Anytype_Model_Block.Content.File.TypeEnum = .none, disableEncryption: Bool = false, style: Anytype_Model_Block.Content.File.Style = .auto) {
        self.url = url
        self.localPath = localPath
        self.type = type
...
extension Anytype_Rpc.History.GetVersions.Request {
    public init(objectID: String = String(), lastVersionID: String = String(), limit: Int32 = 0) {
        self.objectID = objectID
...
extension Anytype_Rpc.History.SetVersion.Request {
    public init(objectID: String = String(), versionID: String = String()) {
        self.objectID = objectID
...
extension Anytype_Rpc.History.ShowVersion.Request {
    public init(objectID: String = String(), versionID: String = String(), traceID: String = String()) {
        self.objectID = objectID
        self.versionID = versionID
...
extension Anytype_Rpc.Object.CreateObjectType.Request {
    public init(details: SwiftProtobuf.Google_Protobuf_Struct, internalFlags: [Anytype_Model_InternalFlag] = []) {
        self.details = details
        self.internalFlags = internalFlags
    }
}
...
extension Anytype_Rpc.Object.CreateObjectType.Response.Error {
    public init(code: Anytype_Rpc.Object.CreateObjectType.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}

extension Anytype_Rpc.Object.CreateRelation.Request {
    public init(details: SwiftProtobuf.Google_Protobuf_Struct) {
        self.details = details
    }
}
...
extension Anytype_Rpc.Object.CreateRelation.Response.Error {
    public init(code: Anytype_Rpc.Object.CreateRelation.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}

extension Anytype_Rpc.Object.CreateRelationOption.Request {
    public init(details: SwiftProtobuf.Google_Protobuf_Struct) {
        self.details = details
    }
}
...
extension Anytype_Rpc.Object.CreateRelationOption.Response.Error {
    public init(code: Anytype_Rpc.Object.CreateRelationOption.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
...
extension Anytype_Rpc.Object.Graph.Edge {
    public init(source: String = String(), target: String = String(), name: String = String(), type: Anytype_Rpc.Object.Graph.Edge.TypeEnum = .link, description_p: String = String(), iconImage: String = String(), iconEmoji: String = String(), hidden: Bool = false) {
        self.source = source
        self.target = target
        self.name = name
        self.type = type
...
extension Anytype_Rpc.Object.Search.Request {
    public init(filters: [Anytype_Model_Block.Content.Dataview.Filter] = [], sorts: [Anytype_Model_Block.Content.Dataview.Sort] = [], fullText: String = String(), offset: Int32 = 0, limit: Int32 = 0, objectTypeFilter: [String] = [], keys: [String] = []) {
        self.filters = filters
        self.sorts = sorts
        self.fullText = fullText
        self.offset = offset
...
extension Anytype_Rpc.Object.SearchSubscribe.Request {
    public init(subID: String = String(), filters: [Anytype_Model_Block.Content.Dataview.Filter] = [], sorts: [Anytype_Model_Block.Content.Dataview.Sort] = [], limit: Int64 = 0, offset: Int64 = 0, keys: [String] = [], afterID: String = String(), beforeID: String = String(), source: [String] = [], ignoreWorkspace: String = String(), noDepSubscription: Bool = false) {
        self.subID = subID
        self.filters = filters
        self.sorts = sorts
        self.limit = limit
...
extension Anytype_Rpc.Object.SearchSubscribe.Response {
    public init(error: Anytype_Rpc.Object.SearchSubscribe.Response.Error, records: [SwiftProtobuf.Google_Protobuf_Struct] = [], dependencies: [SwiftProtobuf.Google_Protobuf_Struct] = [], subID: String = String(), counters: Anytype_Event.Object.Subscription.Counters) {
        self.error = error
        self.records = records
...
extension Anytype_Rpc.Object.SubscribeIds.Response {
    public init(error: Anytype_Rpc.Object.SubscribeIds.Response.Error, records: [SwiftProtobuf.Google_Protobuf_Struct] = [], dependencies: [SwiftProtobuf.Google_Protobuf_Struct] = [], subID: String = String()) {
        self.error = error
        self.records = records
        self.dependencies = dependencies
        self.subID = subID
...
extension Anytype_Rpc.ObjectRelation.Add.Response {
    public init(error: Anytype_Rpc.ObjectRelation.Add.Response.Error, event: Anytype_ResponseEvent) {
        self.error = error
        self.event = event
    }
}
...
extension Anytype_Rpc.Relation.ListRemoveOption.Response {
    public init(error: Anytype_Rpc.Relation.ListRemoveOption.Response.Error) {
        self.error = error
    }
}

extension Anytype_Rpc.Relation.ListRemoveOption.Response.Error {
    public init(code: Anytype_Rpc.Relation.ListRemoveOption.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}

extension Anytype_Rpc.Relation.Options.Request {
    public init(relationKey: String = String()) {
        self.relationKey = relationKey
    }
}

extension Anytype_Rpc.Relation.Options.Response {
    public init(error: Anytype_Rpc.Relation.Options.Response.Error, options: Anytype_Model_RelationOptions) {
        self.error = error
        self.options = options
    }
}

extension Anytype_Rpc.Relation.Options.Response.Error {
    public init(code: Anytype_Rpc.Relation.Options.Response.Error.Code = .null, description_p: String = String()) {
        self.code = code
        self.description_p = description_p
    }
}
