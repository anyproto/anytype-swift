...
public struct ClientCommands {
    ...
    public static func objectRefresh(
        _ request: Anytype_Rpc.Object.Refresh.Request = .init()
    ) -> Invocation<Anytype_Rpc.Object.Refresh.Request, Anytype_Rpc.Object.Refresh.Response> {
        return Invocation(messageName: "ObjectRefresh", request: request) { request in
            let requestData = try request.serializedData()
            let responseData = Lib.ServiceObjectRefresh(requestData) ?? Data()
            return try Anytype_Rpc.Object.Refresh.Response(serializedBytes: responseData)
        }
    }
    ...
    public static func fileSetAutoDownload(
        _ request: Anytype_Rpc.File.SetAutoDownload.Request = .init()
    ) -> Invocation<Anytype_Rpc.File.SetAutoDownload.Request, Anytype_Rpc.File.SetAutoDownload.Response> {
        return Invocation(messageName: "FileSetAutoDownload", request: request) { request in
            let requestData = try request.serializedData()
    ...
    public static func chatReadMessages(
        _ request: Anytype_Rpc.Chat.ReadMessages.Request = .init()
    ) -> Invocation<Anytype_Rpc.Chat.ReadMessages.Request, Anytype_Rpc.Chat.ReadMessages.Response> {
        return Invocation(messageName: "ChatReadMessages", request: request) { request in
            ...
            return try Anytype_Rpc.Chat.ReadMessages.Response(serializedBytes: responseData)
        }
    }
    ...
    public static func chatSubscribeToMessagePreviews(
        ...
        return Invocation(messageName: "ChatSubscribeToMessagePreviews", request: request) { request in
            let requestData = try request.serializedData()
