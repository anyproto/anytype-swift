...
public extension UIFont {
    ...
    static let caption2Regular = UIKitFontBuilder.uiKitFont(font: .caption2Regular)
    static let caption1Semibold = UIKitFontBuilder.uiKitFont(font: .caption1Semibold)
