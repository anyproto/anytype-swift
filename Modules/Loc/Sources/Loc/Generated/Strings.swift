...
public enum Loc {
  ...
  public enum Sharing {
    public static let addTo = Loc.tr("Workspace", "Sharing.AddTo", fallback: "Add to")
    public static let inputPlaceholder = Loc.tr("Workspace", "Sharing.InputPlaceholder", fallback: "Add a comment...")
    public static let linkTo = Loc.tr("Workspace", "Sharing.LinkTo", fallback: "Link to")
    public static let saveAs = Loc.tr("Workspace", "Sharing.SaveAs", fallback: "SAVE AS")
    public static let selectSpace = Loc.tr("Workspace", "Sharing.SelectSpace", fallback: "Space")
    ...
    public enum `Any` {
      public static let block = Loc.tr("Workspace", "Sharing.Any.Block", fallback: "Blocks")
    }
    public enum File {
      public static func block(_ p1: Int) -> String {
        return Loc.tr("Workspace", "Sharing.File.Block", p1, fallback: "Plural format key: Sharing.File.Block")
      }
      public static func newObject(_ p1: Int) -> String {
        return Loc.tr("Workspace", "Sharing.File.NewObject", p1, fallback: "Plural format key: Sharing.File.NewObject")
      }
    }
    public enum Navigation {
      public static let title = Loc.tr("Workspace", "Sharing.Navigation.title", fallback: "Add to Anytype")
      public enum LeftButton {
        public static let title = Loc.tr("Workspace", "Sharing.Navigation.LeftButton.Title", fallback: "Cancel")
      }
      public enum RightButton {
        public static let title = Loc.tr("Workspace", "Sharing.Navigation.RightButton.Title", fallback: "Done")
      }
    }
    ...
    public enum Text {
      public static let noteObject = Loc.tr("Workspace", "Sharing.Text.NoteObject", fallback: "Note object")
      public static let textBlock = Loc.tr("Workspace", "Sharing.Text.TextBlock", fallback: "Blocks")
    }
    public enum Tip {
    ...
    public enum Url {
      public static func block(_ p1: Int) -> String {
        return Loc.tr("Workspace", "Sharing.URL.Block", p1, fallback: "Plural format key: Sharing.URL.Block")
      }
      public static func newObject(_ p1: Int) -> String {
        return Loc.tr("Workspace", "Sharing.URL.NewObject", p1, fallback: "Plural format key: Sharing.URL.NewObject")
      }
    }
  }
  ...
  public enum Spaces {
    ...
    public enum Search {
      public static let title = Loc.tr("Workspace", "Spaces.Search.Title", fallback: "Search spaces")
    }
    public enum UxType {
      public enum Chat {
