...
public protocol WorkspaceServiceProtocol {
    ...
    func createSpace(name: String, gradient: GradientId, accessibility: SpaceAccessibility) async throws -> String
...
public final class WorkspaceService: WorkspaceServiceProtocol {
    ...
    public func createSpace(name: String, gradient: GradientId, accessibility: SpaceAccessibility) async throws -> String {
