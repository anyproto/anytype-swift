//
//  BlocksModels+Parser+Common.swift
//  AnyType
//
...
extension BlocksModels.Parser.Common.Alignment {
    /// Alignment: Conversion between model between middleware and our model.
    enum Converter {
        typealias Model = BlocksModels.Aliases.Alignment
...
extension BlocksModels.Parser.Common.Position {
