//
//  EditorModule+ViewControllers.swift
//  AnyType
//
...
/// Custom `ViewControllers` Namespace for this `EditorModule`.
extension Namespace {
...
///
protocol EditorModuleViewControllersHasOneChildViewControllerConnector {
    associatedtype Parent: UIViewController
    associatedtype Child: UIViewController
    var oneChildViewControllerConnector: EditorModule.ViewControllers.OneChildViewControllerConnector<Parent, Child> {get}
}

extension EditorModuleViewControllersHasOneChildViewControllerConnector where Self: UIViewController {
...
extension FileNamespace {
    ...
    ///
    /// var oneChildViewControllerConnector: EditorModule.ViewControllers.OneChildViewControllerConnector<UIViewController, UIViewController>
    ///
