...
extension Namespace {
    class Cell: UIView {
        ...
        /// Aliases
        typealias Model = EditorModule.Document.ViewController.ViewModel.Row
...
extension Namespace.Cell {
    func onSelectionStateChanged(_ value: EditorModule.Selection.IncomingCellEvent) {
        let event = value
        switch event {
        case .unknown: return
...
// MARK: Protocols
protocol EdiotrModuleDocumentViewCellContentConfigurationsCellsListenerProtocol {
