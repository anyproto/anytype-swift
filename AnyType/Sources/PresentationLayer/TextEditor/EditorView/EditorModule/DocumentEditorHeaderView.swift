...
final class DocumentEditorHeaderView: UICollectionReusableView {
...
final class HeaderView: UIView {
    ...
    // MARK: Variables
    private var layout: DocumentEditorHeaderView.Layout = .init()
    var viewModel: DocumentEditorHeaderView.ViewModel? {
        didSet {
            setupSubscribers()
        }
    }
    ...
    private func process(action: DocumentEditorHeaderView.UserAction) {
        self.viewModel?.process(action: action)
    }

    // MARK: Events
    private func process(event: DocumentEditorHeaderView.UserEvent) {
        switch event {
    ...
    private lazy var contentView: UIView = {
        ...
        view.backgroundColor = DocumentEditorHeaderView.Style.presentation.backgroundColor()
        return view
    }()
...
// MARK: Style
extension DocumentEditorHeaderView {
    enum Style {
        case presentation
...
// MARK: Layout
private extension DocumentEditorHeaderView {
    struct Layout {
...
extension DocumentEditorHeaderView.ViewModel {
