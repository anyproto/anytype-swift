//
//  BlocksViews+New+Text+Checkbox.swift
//  AnyType
//
...
// MARK: - ViewModel
extension BlocksViews.New.Text.Checkbox {
...
private extension BlocksViews.New.Text.Checkbox.ViewModel {
...
// MARK: - Style
private extension BlocksViews.New.Text.Checkbox {
    enum Style {
        case unchecked
        case checked
