...
extension Namespace.ViewController {
    ...
    private func setupCollectionView() {
        ...
        // register cells(?)
        // register them as CellRegistration
        self.collectionView?.register(DocumentModule.Document.Cells.CollectionViewCell.self, forCellWithReuseIdentifier: DocumentModule.Document.Cells.CollectionViewCell.cellReuseIdentifier())
    }
