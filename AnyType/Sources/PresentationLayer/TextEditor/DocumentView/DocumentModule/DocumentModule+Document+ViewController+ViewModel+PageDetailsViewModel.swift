...
fileprivate typealias Namespace = DocumentModule.Document.ViewController.ViewModel
...
extension Namespace {
    ...
    @available(iOS, introduced: 13.0, deprecated: 14.0, message: "This class should be extracted somewhere. Somewhere near EventHandler. Extract EventHandler too.")
