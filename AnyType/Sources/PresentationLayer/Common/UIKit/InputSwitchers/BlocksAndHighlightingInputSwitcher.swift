...
final class BlocksAndHighlightingInputSwitcher: InputSwitcher {
    ...
    override func variantsFromState(_ coordinator: BlockTextViewCoordinator,
        ...
        case (_, is BlockTextView.BlockToolbar.AccessoryView, _): return .init(shouldAnimate: true, accessoryView: coordinator.highlightedAccessoryView, inputView: nil)
    ...
    override func didSwitchViews(_ coordinator: BlockTextViewCoordinator,
                                 textView: UITextView) {
        if (textView.inputAccessoryView is BlockTextView.HighlightedToolbar.AccessoryView) {
