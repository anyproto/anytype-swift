...
struct Anytype_Model_Block {
  ...
  var video: Anytype_Model_Block.Content.Video {
    get {
      if case .video(let v)? = _storage._content {return v}
      return Anytype_Model_Block.Content.Video()
    }
    set {_uniqueStorage()._content = .video(newValue)}
  }

  var image: Anytype_Model_Block.Content.Image {
    get {
      if case .image(let v)? = _storage._content {return v}
      return Anytype_Model_Block.Content.Image()
    }
  ...
  enum OneOf_Content: Equatable {
    ...
    case video(Anytype_Model_Block.Content.Video)
    case image(Anytype_Model_Block.Content.Image)
  ...
  struct Content {
    ...
    struct Video {
      ...
      var state: Anytype_Model_Block.Content.Video.State = .empty
      ...
      enum State: SwiftProtobuf.Enum {
        ...
        /// There is no video and preview, it's an empty block, that waits videos.
        case empty // = 0

        /// There is stil no video/preview, but video already uploading
        case uploading // = 1

        /// Video exists, preview downloaded, but video – not.
        case previewDownloaded // = 2

        /// Video exists, preview downloaded, but video downloading
        case downloading // = 3

        /// Video and preview downloaded
        case done // = 4
        case UNRECOGNIZED(Int)
        ...
        var rawValue: Int {
          ...
          case .previewDownloaded: return 2
    ...
    struct Image {
      ...
      var previewFilePath: String = String()

      var state: Anytype_Model_Block.Content.Image.State = .empty

      var type: Anytype_Model_Block.Content.Image.TypeEnum = .png
      ...
      enum State: SwiftProtobuf.Enum {
        ...
        /// There is no image and preview, it's an empty block, that waits image.
        case empty // = 0

        /// There is stil no image/preview, but image already uploading
        case uploading // = 1

        /// Image exists, preview downloaded, but image – not.
        case previewDownloaded // = 2

        /// Image exists, preview downloaded, but image downloading
        case downloading // = 3

        /// Image and preview downloaded
        case done // = 4
        case UNRECOGNIZED(Int)
    ...
    struct File {
      ...
      /// Path to the file on a local machine
      var localFilePath: String = String()
...
struct Anytype_Model_Account {
  ...
  struct Avatar {
    ...
    var image: Anytype_Model_Image {
      get {
        if case .image(let v)? = _storage._avatar {return v}
        return Anytype_Model_Image()
      }
    ...
    enum OneOf_Avatar: Equatable {
      /// Image of the avatar. Contains hash and size
      case image(Anytype_Model_Image)
      /// Color of the avatar, if no image
      case color(String)
...
struct Anytype_Model_Image {
  ...
  var sizes: [Anytype_Model_Image.Size] = []

  var style: Anytype_Model_Image.Style = .picture
...
extension Anytype_Model_Image.Size: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Anytype_Model_Image.Size] = [
    .large,
    .small,
    .thumb,
  ]
...
extension Anytype_Model_Image.Style: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Anytype_Model_Image.Style] = [
    .picture,
    .file,
  ]
}
...
struct Anytype_Model_Video {
  ...
  var sizes: [Anytype_Model_Video.Size] = []
  ...
  enum Size: SwiftProtobuf.Enum {
    ...
    init?(rawValue: Int) {
      ...
      case 2: self = .hd720P
      case 3: self = .hd1080P
      case 4: self = .uhd1440P
      case 5: self = .uhd2160P
      default: self = .UNRECOGNIZED(rawValue)
      }
    }
    ...
    var rawValue: Int {
      switch self {
      case .sd360P: return 0
      case .sd480P: return 1
      case .hd720P: return 2
      case .hd1080P: return 3
      case .uhd1440P: return 4
      case .uhd2160P: return 5
      case .UNRECOGNIZED(let i): return i
      }
    }
...
extension Anytype_Model_Video.Size: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Anytype_Model_Video.Size] = [
    .sd360P,
    .sd480P,
    .hd720P,
    .hd1080P,
...
extension Anytype_Model_Block: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    16: .same(proto: "image"),
    17: .same(proto: "file"),
    18: .same(proto: "layout"),
    19: .same(proto: "div"),
    20: .same(proto: "bookmark"),
    21: .same(proto: "icon"),
    22: .same(proto: "link"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 15:
          var v: Anytype_Model_Block.Content.Video?
          if let current = _storage._content {
            try decoder.handleConflictingOneOf()
            if case .video(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._content = .video(v)}
        case 16:
          var v: Anytype_Model_Block.Content.Image?
          if let current = _storage._content {
            try decoder.handleConflictingOneOf()
...
extension Anytype_Model_Block.Content.Video: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Anytype_Model_Block.Content.protoMessageName + ".Video"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "localFilePath"),
    2: .same(proto: "name"),
    3: .same(proto: "icon"),
    4: .same(proto: "width"),
    5: .same(proto: "state"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeSingularInt32Field(value: &self.width)
  ...
  static func ==(lhs: Anytype_Model_Block.Content.Video, rhs: Anytype_Model_Block.Content.Video) -> Bool {
...
extension Anytype_Model_Block.Content.Video.State: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "Empty"),
    1: .same(proto: "Uploading"),
    2: .same(proto: "PreviewDownloaded"),
    3: .same(proto: "Downloading"),
    4: .same(proto: "Done"),
  ]
}

extension Anytype_Model_Block.Content.Image: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Anytype_Model_Block.Content.protoMessageName + ".Image"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "localFilePath"),
    2: .same(proto: "previewFilePath"),
    3: .same(proto: "state"),
    4: .same(proto: "type"),
    5: .same(proto: "name"),
    6: .same(proto: "size"),
    7: .same(proto: "addedAt"),
    8: .same(proto: "width"),
    9: .same(proto: "widthToHeight"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.localFilePath)
      case 2: try decoder.decodeSingularStringField(value: &self.previewFilePath)
      ...
      case 6: try decoder.decodeSingularInt32Field(value: &self.size)
      case 7: try decoder.decodeSingularInt32Field(value: &self.addedAt)
      case 8: try decoder.decodeSingularInt32Field(value: &self.width)
      case 9: try decoder.decodeSingularInt32Field(value: &self.widthToHeight)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.previewFilePath.isEmpty {
      try visitor.visitSingularStringField(value: self.previewFilePath, fieldNumber: 2)
    }
    if self.state != .empty {
    ...
    if self.addedAt != 0 {
      try visitor.visitSingularInt32Field(value: self.addedAt, fieldNumber: 7)
    }
    if self.width != 0 {
      try visitor.visitSingularInt32Field(value: self.width, fieldNumber: 8)
    }
    if self.widthToHeight != 0 {
      try visitor.visitSingularInt32Field(value: self.widthToHeight, fieldNumber: 9)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Anytype_Model_Block.Content.Image, rhs: Anytype_Model_Block.Content.Image) -> Bool {
    if lhs.localFilePath != rhs.localFilePath {return false}
    if lhs.previewFilePath != rhs.previewFilePath {return false}
    if lhs.state != rhs.state {return false}
    ...
    if lhs.width != rhs.width {return false}
    if lhs.widthToHeight != rhs.widthToHeight {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Anytype_Model_Block.Content.Image.State: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "Empty"),
    1: .same(proto: "Uploading"),
    2: .same(proto: "PreviewDownloaded"),
...
extension Anytype_Model_Block.Content.Image.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "Png"),
    1: .same(proto: "Jpg"),
  ]
...
extension Anytype_Model_Image: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedEnumField(value: &self.sizes)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.sizes.isEmpty {
      try visitor.visitPackedEnumField(value: self.sizes, fieldNumber: 2)
    }
  ...
  static func ==(lhs: Anytype_Model_Image, rhs: Anytype_Model_Image) -> Bool {
...
extension Anytype_Model_Image.Size: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "Large"),
    1: .same(proto: "Small"),
    2: .same(proto: "Thumb"),
...
extension Anytype_Model_Image.Style: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Anytype_Model_Video: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Anytype_Model_Video, rhs: Anytype_Model_Video) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.sizes != rhs.sizes {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Anytype_Model_Video.Size: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "SD360p"),
    1: .same(proto: "SD480p"),
    2: .same(proto: "HD720p"),
    3: .same(proto: "HD1080p"),
    4: .same(proto: "UHD1440p"),
    5: .same(proto: "UHD2160p"),
  ]
}
