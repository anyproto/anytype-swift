...
struct Anytype_Model_Block {
  ...
  struct Content {
    ...
    struct Dataview {
      ...
      var views: [Anytype_Model_Block.Content.Dataview.View] = []
      ...
      struct View {
        ...
        var type: Anytype_Model_Block.Content.Dataview.View.TypeEnum = .table

        var name: String = String()

        var sorts: [Anytype_Model_Block.Content.Dataview.Sort] = []

        var filters: [Anytype_Model_Block.Content.Dataview.Filter] = []

        /// relations fields/columns options, also used to provide the order
        var relations: [Anytype_Model_Block.Content.Dataview.Relation] = []
      ...
      struct Relation {
        ...
        var options: Anytype_Model_Block.Content.Dataview.Relation.OneOf_Options? = nil

        var emptyOptions: Anytype_Model_Block.Content.Dataview.Relation.EmptyOptions {
          get {
        ...
        var dateOptions: Anytype_Model_Block.Content.Dataview.Relation.DateOptions {
          get {
        ...
        #if !swift(>=4.1)
          static func ==(lhs: Anytype_Model_Block.Content.Dataview.Relation.OneOf_Options, rhs: Anytype_Model_Block.Content.Dataview.Relation.OneOf_Options) -> Bool {
            switch (lhs, rhs) {
            case (.emptyOptions(let l), .emptyOptions(let r)): return l == r
            case (.dateOptions(let l), .dateOptions(let r)): return l == r
            default: return false
            }
          }
        #endif
        ...
        enum DateFormat: SwiftProtobuf.Enum {
          typealias RawValue = Int
        ...
        enum TimeFormat: SwiftProtobuf.Enum {
          typealias RawValue = Int
          case format12 // = 0
          case format24 // = 1
          case UNRECOGNIZED(Int)
        ...
        struct DateOptions {
          ...
          var timeFormat: Anytype_Model_Block.Content.Dataview.Relation.TimeFormat = .format12

          var dateFormat: Anytype_Model_Block.Content.Dataview.Relation.DateFormat = .monthAbbrBeforeDay
      ...
      struct Sort {
        ...
        var type: Anytype_Model_Block.Content.Dataview.Sort.TypeEnum = .asc
      ...
      struct Filter {
        ...
        var `operator`: Anytype_Model_Block.Content.Dataview.Filter.Operator = .and

        var relationID: String = String()

        var relationProperty: String = String()

        var condition: Anytype_Model_Block.Content.Dataview.Filter.Condition = .equal
...
extension Anytype_Model_Block.Content.Dataview.View.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Anytype_Model_Block.Content.Dataview.View.TypeEnum] = [
    .table,
    .list,
    .gallery,
    .kanban,
...
extension Anytype_Model_Block.Content.Dataview.Relation.DateFormat: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Anytype_Model_Block.Content.Dataview.Relation.DateFormat] = [
    .monthAbbrBeforeDay,
    .monthAbbrAfterDay,
    .short,
    .shortUs,
...
extension Anytype_Model_Block.Content.Dataview.Relation.TimeFormat: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Anytype_Model_Block.Content.Dataview.Relation.TimeFormat] = [
    .format12,
    .format24,
  ]
}
...
extension Anytype_Model_Block.Content.Dataview.Sort.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Anytype_Model_Block.Content.Dataview.Sort.TypeEnum] = [
    .asc,
    .desc,
  ]
}
...
extension Anytype_Model_Block.Content.Dataview.Filter.Operator: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Anytype_Model_Block.Content.Dataview.Filter.Operator] = [
    .and,
    .or,
  ]
}
...
extension Anytype_Model_Block.Content.Dataview.Filter.Condition: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Anytype_Model_Block.Content.Dataview.Filter.Condition] = [
    .equal,
    .notEqual,
    .greater,
    .less,
...
extension Anytype_Model_Block.Content.Dataview: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedMessageField(value: &self.views)
      case 3: try decoder.decodeSingularStringField(value: &self.schemaURL)
      default: break
      }
    }
  }
...
extension Anytype_Model_Block.Content.Dataview.View: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Anytype_Model_Block.Content.Dataview.protoMessageName + ".View"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "type"),
    3: .same(proto: "name"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeRepeatedMessageField(value: &self.sorts)
      case 5: try decoder.decodeRepeatedMessageField(value: &self.filters)
      case 6: try decoder.decodeRepeatedMessageField(value: &self.relations)
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Anytype_Model_Block.Content.Dataview.View, rhs: Anytype_Model_Block.Content.Dataview.View) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.type != rhs.type {return false}
    if lhs.name != rhs.name {return false}
...
extension Anytype_Model_Block.Content.Dataview.Relation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Anytype_Model_Block.Content.Dataview.protoMessageName + ".Relation"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.id)
      case 2: try decoder.decodeSingularBoolField(value: &self.isVisible)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    switch self.options {
    case .emptyOptions(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
    case .dateOptions(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 11)
    case nil: break
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  static func ==(lhs: Anytype_Model_Block.Content.Dataview.Relation, rhs: Anytype_Model_Block.Content.Dataview.Relation) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Anytype_Model_Block.Content.Dataview.Relation.EmptyOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Anytype_Model_Block.Content.Dataview.Relation.protoMessageName + ".EmptyOptions"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Anytype_Model_Block.Content.Dataview.Relation.EmptyOptions, rhs: Anytype_Model_Block.Content.Dataview.Relation.EmptyOptions) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Anytype_Model_Block.Content.Dataview.Relation.DateOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Anytype_Model_Block.Content.Dataview.Relation.protoMessageName + ".DateOptions"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBoolField(value: &self.includeTime)
      case 2: try decoder.decodeSingularEnumField(value: &self.timeFormat)
      case 3: try decoder.decodeSingularEnumField(value: &self.dateFormat)
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Anytype_Model_Block.Content.Dataview.Relation.DateOptions, rhs: Anytype_Model_Block.Content.Dataview.Relation.DateOptions) -> Bool {
...
extension Anytype_Model_Block.Content.Dataview.Sort: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Anytype_Model_Block.Content.Dataview.protoMessageName + ".Sort"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.relationID)
      case 2: try decoder.decodeSingularEnumField(value: &self.type)
      default: break
      }
    }
  ...
  static func ==(lhs: Anytype_Model_Block.Content.Dataview.Sort, rhs: Anytype_Model_Block.Content.Dataview.Sort) -> Bool {
...
extension Anytype_Model_Block.Content.Dataview.Filter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Anytype_Model_Block.Content.Dataview.protoMessageName + ".Filter"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.relationID)
      ...
      case 5: try decoder.decodeSingularStringField(value: &self.relationProperty)
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Anytype_Model_Block.Content.Dataview.Filter, rhs: Anytype_Model_Block.Content.Dataview.Filter) -> Bool {
