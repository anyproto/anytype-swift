...
final class SeedService: SeedServiceProtocol {
    ...
    func containsSeed(for publicKey: String?) -> Bool {
        let seedQuery = GenericPasswordQueryable(account: publicKey ?? SeedServiceConstants.defaultName, service: SeedServiceConstants.serviceName)
    ...
    func removeSeed(for publicKey: String?, keychainPassword: KeychainPasswordType?) throws {
        let seedQuery = GenericPasswordQueryable(account: publicKey ?? SeedServiceConstants.defaultName, service: SeedServiceConstants.serviceName, keyChainPassword: keychainPassword)
    ...
    func obtainSeed(for name: String?, keychainPassword: KeychainPasswordType?) throws -> String {
        let seedQuery = GenericPasswordQueryable(account: name ?? SeedServiceConstants.defaultName, service: SeedServiceConstants.serviceName, keyChainPassword: keychainPassword)
