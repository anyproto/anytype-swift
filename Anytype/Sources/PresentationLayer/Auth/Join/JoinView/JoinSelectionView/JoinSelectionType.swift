...
extension JoinSelectionType {
    ...
    static let otherOptions: [InfoSelectionOption] = [InfoSelectionOption(icon: .SelectionOption.other, title: Loc.other, analyticsValue: "Other")]
}
