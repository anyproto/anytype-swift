...
struct OldSpaceCard: View, @preconcurrency Equatable {
    ...
    var body: some View {
        ...
        .disabled(FeatureFlags.spaceLoadingForScreen ? false : space.space.spaceView.isLoading)
        .contextMenu {
...
//        }
        ...
        Divider()
        if space.space.canLeave {
            leaveButton
        }
        if space.space.canBeDeleted {
            deleteButton
        }
    }
