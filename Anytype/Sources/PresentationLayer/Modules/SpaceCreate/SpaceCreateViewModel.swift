...
final class SpaceCreateViewModel: ObservableObject {
    ...
    func onTapCreate() {
        ...
        Task {
            ...
            let spaceId = try await workspaceService.createSpace(name: spaceName, iconOption: spaceIconOption, accessType: spaceAccessType, useCase: .getStarted, withChat: FeatureFlags.homeSpaceLevelChat)
