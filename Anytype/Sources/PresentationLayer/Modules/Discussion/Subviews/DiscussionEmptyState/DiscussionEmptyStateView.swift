...
struct DiscussionEmptyStateView: View {
    ...
    @StateObject private var model: DiscussionEmptyStateViewModel
    @FocusState private var focusedField: Field?
    
    init(objectId: String, onIconSelected: @escaping () -> Void, onDone: @escaping () -> Void) {
        self._model = StateObject(wrappedValue: DiscussionEmptyStateViewModel(objectId: objectId, onIconSelected: onIconSelected, onDone: onDone))
    }
