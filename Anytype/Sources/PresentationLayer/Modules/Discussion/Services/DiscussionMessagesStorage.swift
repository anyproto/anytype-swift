...
protocol DiscussionMessagesStorageProtocol: AnyObject, Sendable {
...
actor DiscussionMessagesStorage: DiscussionMessagesStorageProtocol {
    ...
    private let subId = "DiscussionMessagesStorage-\(UUID().uuidString)"
...
extension Container {
    var discussionMessageStorage: ParameterFactory<(String, String), any DiscussionMessagesStorageProtocol> {
        self { DiscussionMessagesStorage(spaceId: $0, chatObjectId: $1) }
    }
}
