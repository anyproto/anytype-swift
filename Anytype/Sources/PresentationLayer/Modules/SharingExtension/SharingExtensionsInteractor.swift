...
protocol SharingExtensionsInteractorProtocol: AnyObject, Sendable {
    func saveChatMessage(spaceId: String, chatId: String, content: SharedContent) async throws
}

final class SharingExtensionsInteractor: ShareLegacyOptionsInteractorProtocol {
