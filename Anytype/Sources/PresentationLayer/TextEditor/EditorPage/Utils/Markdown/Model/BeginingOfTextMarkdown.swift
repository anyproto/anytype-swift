...
extension BeginingOfTextMarkdown {
    ...
    static let all: [BeginingOfTextMarkdown] = [
        BeginingOfTextMarkdown(text: "###> ", type: .text(.toggleHeader3)),
        BeginingOfTextMarkdown(text: "##> ", type: .text(.toggleHeader2)),
        BeginingOfTextMarkdown(text: "#> ", type: .text(.toggleHeader)),
