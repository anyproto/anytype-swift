...
final class ObjectSettingsViewModel: ObservableObject, Dismissible {
    ...
    private(set) var popupLayout: FloatingPanelLayout = ConstantHeightPopupLayout(height: 0, floatingPanelStyle: true)
    ...
    func viewDidUpdateHeight(_ height: CGFloat) {
        popupLayout = ConstantHeightPopupLayout(height: height, floatingPanelStyle: true)
