...
final class LoginStateService: LoginStateServiceProtocol, Sendable {
    ...
    private let objectTypeWidgetExpandedService: any ObjectTypeWidgetExpandedServiceProtocol = Container.shared.objectTypeWidgetExpandedService()
    ...
    func cleanStateAfterLogout() async {
        ...
        objectTypeWidgetExpandedService.clearData()
