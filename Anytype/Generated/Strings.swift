...
internal enum Loc {
  ...
  internal static let listOfRelatedObjects = Loc.tr("Localizable", "List of related objects", fallback: "Properties and related objects")
  ...
  internal static let newRelation = Loc.tr("Localizable", "New relation", fallback: "New field")
  ...
  internal enum ObjectSettings {
    internal enum History {
      internal static let description = Loc.tr("Localizable", "ObjectSettings.History.Description", fallback: "All versions of object")
    }
  }
  internal enum ObjectType {
  ...
  internal enum Relation {
    internal static func addedToLibrary(_ p1: Any) -> String {
      return Loc.tr("Localizable", "Relation.AddedToLibrary", String(describing: p1), fallback: "field ‘%@’ added to your library")
    }
    ...
    internal enum Date {
      internal enum Locked {
        internal enum Alert {
          internal static func title(_ p1: Any) -> String {
            return Loc.tr("Localizable", "Relation.Date.Locked.Alert.title", String(describing: p1), fallback: "Field “%@” is locked")
          }
        }
      }
    }
  ...
  internal enum Widgets {
    ...
    internal enum Layout {
      ...
      internal enum View {
        internal static let description = Loc.tr("Localizable", "Widgets.Layout.View.Description", fallback: "Widget with a Set or Collection layout")
