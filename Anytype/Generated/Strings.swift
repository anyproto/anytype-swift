...
internal enum Loc {
  ...
  internal enum SpaceShare {
    ...
    internal enum DeleteSharingLink {
      internal static let message = Loc.tr("Localizable", "SpaceShare.DeleteSharingLink.Message", fallback: "New members won’t be able to join the space. You can generate a new link anytyme")
